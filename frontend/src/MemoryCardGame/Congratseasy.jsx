...
import bgMusicPath from "../../public/audio/Star1.mp3"; // Use absolute path
import congratulationImage from "../../public/images/Star.jpg"; // Use absolute path
...
const Congteasy = () => {
  ...
  const handlePlayAgain = () => {
    ...
    navigate("/easy"); // Navigate to the easy game
  };
